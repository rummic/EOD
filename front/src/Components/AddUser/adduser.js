                ...
                <div className="UsersetBox-content">
                    <div className="UsersetBox-form">
                        <div className="UsersetBox-form-content">
                            ...
                            <label>Nazwisko :</label><input type="text" placegoler="Podaj Nazwisko" name="lastName" onChange={this.onChange} required/>
                            <label>Login :</label><input type="text" placeholer="Podaj Login" name="login" onChange={this.onChange} required/>
